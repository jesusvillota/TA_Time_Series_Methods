...
\title{Data Download Guide: Time Series for Empirical Applications}
...
You will need to download 27 CSV files from three main sources:

\begin{itemize}
    \item \textbf{FRED (Federal Reserve Economic Data):} 23 files total (12 US data + 7 European bond yields + 4 Spanish data)
...
\subsection*{Step 2: Download US Data from FRED (12 files)}
